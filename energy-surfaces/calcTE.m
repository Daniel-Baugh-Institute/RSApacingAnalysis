function [meanP,minP,medianP,stdP,meanTE] = calcTE(PDF,num_subjects)
...
for i = 1:num_subjects
    ...
    meanP(i) = mean(nonzeros(P));
    minP(i) = min(min(P));
    medianP(i) = median(nonzeros(P));
    stdP(i) = std(nonzeros(P));
