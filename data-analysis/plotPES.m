...
parfor jj = 1:num_subjects
    for i = 1:num_slices
        ...
        if strcmp(var1, 'CO') && strcmp(var2, 'CoBF')
            ...
            yy = 0:10:400;
            plot_type = 1;
            if jj == 10 || any(isnan(annotated_data(i,jj).CO(:,1))) || any(isnan(annotated_data(i,jj).CoBF(:,1))) || isempty(annotated_data(i,jj).CO(:,1))
        ...
        %         filename = 'plot_CO_CoBF_probability_subplot_1h_24slices.png';
        % 
