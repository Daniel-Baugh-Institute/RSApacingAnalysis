function [ hrv_td, plot_data ] = hrv_time( nni, filename, varargin )
...
should_plot = 1;
if should_plot
    cd '/lustre/ogunnaike/users/2420/matlab_example/NZ-physiology-data/'
    figure('Name', plot_data.name);
    mhrv.plots.plot_hrv_time_hist(gca, plot_data);
    saveas(gcf,filename)
end
