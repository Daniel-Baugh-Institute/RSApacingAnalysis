function [ hrv_fd, pxx, f_axis, plot_data ] = hrv_freq( nni, filename, varargin )
...
if (should_plot)
    ...
    mhrv.plots.plot_hrv_freq_spectrum(gca, plot_data, 'peaks', true);
    saveas(gcf,filename{1})
    
    figure('Name', 'Beta');
    mhrv.plots.plot_hrv_freq_beta(gca, plot_data);
    saveas(gcf,filename{2})
end
end
