function [ hrv_frag, acceleration_segment_boundaries_3plus, alternation_segment_boundaries_4plus ] = hrv_fragmentation_filtered( nni, varargin )
...
% Modified by MMG to filter out small NN differences
diff_thresh = 0.01; % largest difference between NN intervals to count as noise
idx2zero = find(dnni < diff_thresh & dnni > -diff_thresh);
dnni(idx2zero) = 0;
...
% three intervals
acceleration_segment_boundaries_ip_idx = find(diff(ip_idx) > 2);
